...
<figure>
    <img src="/assets/images/07-28/gakona.jpg">
        <figcaption>
We crossed the Gakona Glacier, which required careful planning of the route. We used our drone again for scouting, saving us a lot of walking on unstable moraine looking for crossings.
    </figcaption>
</figure>
...
<figure>
    <img src="/assets/images/07-28/slana.jpg">
        <figcaption>
We followed a mining road that went from the Chistochina Glacier all the way too Mentasta Village following the Slana River. The road was very wide which made it for easy walking except when it crossed the powerful river, which we tried to avoid as much as possible. The road is visible on the lower left corner of the photo.
    </figcaption>
</figure>

<figure>
    <img src="/assets/images/07-28/bear-prints.jpg">
        <figcaption>
We started seeing many bear prints along the river tracks. As we finally found a good campsite, we heard a noise in the bushes. It was a black bear that thankfully ran away. After that, we continued walking for a while longer before setting down for the night.
    </figcaption>
</figure>

<figure>
    <img src="/assets/images/07-28/salmon.jpg">
        <figcaption>
We finally understood why there were so many bears in the area. The salmon that came up through the Copper River were spawning in the side arms and creeks surrounding the Slana River.
    </figcaption>
</figure>
