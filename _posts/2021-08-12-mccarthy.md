...
<figure>
    <img src="/assets/images/08-10/flooded-forest.jpg">
        <figcaption>
After the 4-hour crossing of the Nabesna river we hit a terrible section of dense forest that was being flooded by the river. Bushwhacking was not only slow and brushy, but icy cold on our feet.
    </figcaption>
</figure>
...
<figure>
    <img src="/assets/images/08-10/savanna.jpg">
        <figcaption>
The White River valley contained landscapes new to us, very dry gravel bars with barely any vegetation and the omnipresent glaciated peaks in the background.
    </figcaption>
</figure>
...
<figure>
    <img src="/assets/images/08-10/easy-bushwhack.jpg">
        <figcaption>
It's difficult to predict how hard it will be to travel through a patch of forest from satellite imagery alone, but in this case we were lucky as the forest was open and easy to walk on.
    </figcaption>
</figure>